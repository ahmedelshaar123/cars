...
<div class=" position-relative " style="margin-top: 120px;">
    ...
    <div class=" position-absolute bread-crum text-center">
        <h3 class="  text-white d-block text-center h2 hvr-pop">About Us</h3>
...
<div class="about-2 py-5 mb-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <h2 class="font-weight-bold pb-4 hvr-float-shadow">Our Message</h2>
                {!! $message->$valueVC !!}
            </div>
            <div class="col-lg-6">
                <h2 class="font-weight-bold pb-4 hvr-float-shadow">Our Vision</h2>
                {!! $vision->$valueVC !!}
            </div>
        </div>
    </div>
